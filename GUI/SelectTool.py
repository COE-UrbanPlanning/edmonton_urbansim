...
class SelectMapTool(QgsMapTool):   
    ...
    def canvasPressEvent(self,event):
        ...
        capture_string = QString("Starting Selection")
    ...
    def canvasReleaseEvent(self,e):
        ...
        searchRadius = 0 #(QgsTolerance.toleranceInMapUnits( 5, self.layer, 
...
#			print feature.id()
    ...
    def activate(self):
        #print "Start Selection Tool"
        capture_string = QString("Starting Selection")
        self.canvas.setCursor(self.cursor)
        capture_string = QString("Click point on canvas " +
                                 "to capture coordinates...")
        print capture_string

    def deactivate(self):
        capture_string = QString("End Selection Tool")
        print capture_string
