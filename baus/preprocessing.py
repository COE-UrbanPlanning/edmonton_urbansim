...
@orca.step()
def preproc_buildings(store, buildings, parcels, manual_edits):
    # start with buildings from urbansim_defaults
    df = buildings
    
#    print ""
#    print df.residential_units
#    print ""
    
    print ""
    print parcels.to_frame()
    print "Heyowza!"
    print ""
    ...
    df = df.to_frame().drop(['development_type_id', 'improvement_value',
